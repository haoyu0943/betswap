var ImagePreview = {
    default_params: {}, init: function (a) {
        if (a) {
        ...
        $("body").append('<div id="ip-left" style="display: none; width: 60px; height: 60px;left: 5px; top: 50%;margin-top: -30px; position:fixed;z-index:19941207; cursor: pointer;"><div style="left:-30px;border: 30px solid;border-color: transparent #000000 transparent transparent;position: absolute;"></div></div>');
        $("body").append('<div id="ip-right" style="display: none; width: 60px; height: 60px; right: 5px; top: 50%; margin-top: -30px;position:fixed; z-index:19941207;cursor: pointer;"><div style="left:30px;border: 30px solid;border-color: transparent transparent transparent #000000;position: absolute;"></div></div>')
