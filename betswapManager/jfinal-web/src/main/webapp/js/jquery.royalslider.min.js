...
(function(l) {
    function v(b, f) {
        ...
        for (var d = document.createElement("div").style, j = ["webkit", "Moz", "ms", "O"], h = "", k = 0, m, c = 0; c < j.length; c++) m = j[c],
        ...
        a._c = 0;
        if (a.st.allowCSS3 && (!e || a.st.allowCSS3OnWebkit)) c = h + (h ? "T": "t"),
        a._d = c + "ransform" in d && c + "ransition" in d,
        a._d && (a._e = h + (h ? "P": "p") + "erspective" in d);
        h = h.toLowerCase();
        a._f = "-" + h + "-";
        ...
        a.slides = [];
        a._q = 0; (a.st.slides ? l(a.st.slides) : a.slider.children().detach()).each(function() {
            a._r(this, !0)
        });
        ...
        a._r1 = 0;
        a._d ? (a._s1 = "transition-property", a._t1 = "transition-duration", a._u1 = "transition-timing-function", a._v1 = a._w1 = a._f + "transform", a._e ? (e && a.slider.addClass("rsWebkit3d"), a._x1 = "translate3d(", a._y1 = "px, ", a._z1 = "px, 0px)") : (a._x1 = "translate(", a._y1 = "px, ", a._z1 = "px)"), a._k ? a._o1[a._f + a._s1] = a._f + "transform": (d = {},
        d[a._f + a._s1] = "opacity", d[a._f + a._t1] = a.st.transitionSpeed + "ms", d[a._f + a._u1] = a.st.css3easeInOut, c.css(d))) : (a._w1 = "left", a._v1 = "top");
        var n;
        l(window).on("resize.rs",
        function() {
            n && clearTimeout(n);
        ...
        a.st.arrowsNav && (c = a._n1, l('<div class="rsArrow rsArrowLeft"><div class="rsArrowIcn"></div></div><div class="rsArrow rsArrowRight"><div class="rsArrowIcn"></div></div>').appendTo(c), a._b2 = c.children(".rsArrowLeft").click(function(b) {
            ...
            b.preventDefault();
            a.next()
        }), a.st.arrowsNavAutoHide && !a.hasTouch && (a._b2.addClass("rsHidden"), a._c2.addClass("rsHidden"), c.one("mousemove.arrowshover",
        function() {
    ...
    v.prototype = {
        ...
        _r: function(b, f) {
            ...
            if (!e.stopParsing) return b = g._j2,
            e.id = g._q,
            e.contentAdded = !1,
            g._q++,
            e.images = [],
        ...
        _a2: function() {
            ...
            b._a.on("keydown.rskb",
            function(a) {
                if (!b._k2 && (c = a.keyCode, (37 === c || 39 === c) && !f)) g(c),
        ...
        _m2: function(b, f) {
            ...
            if (t) for (h = n; h < n + q + 1; h++) s = e(h),
            p = Math.floor((d._t - (n - h)) / d.numSlides) * d.numSlides,
            (j = d.slides[s]) && c(j, s);
            if (u) for (h = n - 1; h > n - 1 - q; h--) s = e(h),
            p = Math.floor((d._t - (n - h)) / m) * m,
            (j = d.slides[s]) && c(j, s);
            if (!b) {
                r = e(n - q);
                n = e(n + q);
                q = r > n ? 0 : r;
                for (h = 0; h < m; h++) if (! (r > n && h > r - 1) && (h < q || h > n)) if ((j = d.slides[h]) && j.holder) j.holder.detach(),
                j.isAdded = !1
            }
        },
        setItemHtml: function(b, f) {
            ...
            function e() {
                if (!b.isAppended) {
                    ...
                    a[k._f + "transition"] = "opacity 400ms ease-in-out",
                    b.content.css(a),
                    setTimeout(function() {
        ...
        _f2: function(b, f) {
            ...
            if (l(b.target).closest(".rsNoDrag", c._q1).length) return c.dragSuccess = !1,
            !0; ! f && c._q2 && (c._r2 = !0, c._s2());
            c.dragSuccess = !1;
        ...
        _v2: function(b, f) {
            ...
            c.msEnabled && (g = g.originalEvent);
            c._y2 || (c._d && (!f ? c._o1: c._q3).css(c._f + c._t1, "0s"),
            function d() {
                c._k2 && (c._r3 = requestAnimationFrame(d), c._s3 && c._i3(c._s3, f))
            } ());
            if (c._j3) b.preventDefault(),
            c._k3 = (new Date).getTime(),
            c._s3 = g;
        ...
        updateSliderSize: function(b) {
            ...
            if (b || f != this.width || c != this.height) {
                ...
                b.positionSet = !1,
                b && (b.images && b.isLoaded) && (b.isRendered = !1, this._p2(b));
                if (this._c4) for (f = 0; f < this._c4.length; f++) b = this._c4[f],
                b.holder.css(this._h, (b.id + this._c1) * this._v);
                this._m2();
        ...
        _s2: function(b) {
            ...
            } else this._o1.stop(!0),
            this._o = parseInt(this._o1.css(this._w1), 10);
            ...
            if (!b.isRendered) {
                ...
                if (f) {
                    ...
                    if ("none" !== e || a) {
                        ...
                        if ("fill" === e || "fit" === e) h = b / j,
                        k = d / c,
                        h = "fill" == e ? h > k ? h: k: "fit" == e ? h < k ? h: k: 1,
                        j = Math.ceil(j * h, 10),
                        c = Math.ceil(c * h, 10);
    ...
    j.extend(j.rsProto, {
        _p4: function() {
            function k() {
                ...
                if (a.currSlide && a.currSlide.isLoaded && a._t4 !== e) {
                    ...
                    if (0 < a._r4.length) {
                        var g;
                        for (b = 0; b < a._r4.length; b++) if (g = a._r4[b]) a._d ? (g.block.css(a._f + a._t1, "0s"), g.block.css(g.css)) : g.running ? g.block.stop(!0, !0) : g.block.css(g.css),
                        a._t4 = null,
        ...
        _u4: function(k) {
            ...
            k.each(function(k) {
                ...
                c.css3Easing = j.rsCSS3Easing[c.easing],
                c.delay = b.data("delay"),
                isNaN(c.delay) && (c.delay = a.st.block.delay * k);
                d = {};
        ...
        _w4: function() {
            ...
            if (a.st.autoHeight) {
                var b, d, e, c = function(c) {
                    ...
                    if (b = e.holder) if ((d = b.height()) && void 0 !== d) a._a4 = d,
                    a._d || !c ? a._d1.css("height", d) : a._d1.stop(!0, !0).animate({
                        height: d
                    },
...
(function(b) {
    b.extend(b.rsProto, {
        ...
        _z4: function() {
            ...
            a.startAutoPlay();
            a.ev.on("rsAfterContentSet",
            function(d, b) { ! a._k2 && (!a._q2 && a._a5 && b === a.currSlide) && a._b5()
            });
        ...
        _b5: function() {
            var a = this; ! a._f5 && !a._e5 && (a._g5 = !0, a._h5 && clearTimeout(a._h5), a._h5 = setTimeout(function() {
                var b; ! a._y && !a.st.loopRewind && (b = !0, a.st.loopRewind = !0);
                a.next(!0);
                b && (a.st.loopRewind = !1)
            },
...
(function(a) {
    a.extend(a.rsProto, {
        _o5: function() {
            ...
            b.st.deeplinking = a.extend({},
            b._p5, b.st.deeplinking);
    ...
    if (a.browser.msie && !j) {
        var k, m;
        d.start = function() {
            k || (m = (m = a.fn.hashchange.src) && m + c(), k = a('<iframe tabindex="-1" title="empty"/>').hide().one("load",
            function() {
                m || q(c());
                p()
...
(function(c) {
    c.extend(c.rsProto, {
        ...
        _s5: function() {
            ...
            a.st.fullscreen.buttonFS && (a._v5 = c('<div class="rsFullscreenBtn"><div class="rsFullscreenIcn"></div></div>').appendTo(a._n1).on("click.rs",
            function() {
        ...
        enterFullscreen: function(a) {
            ...
            if (b._u5) if (a) b._u5.requestFullScreen(c("html")[0]);
                ...
                b._a.on(b._u5.fullScreenEventName,
                function() {
...
(function(e) {
    e.extend(e.rsProto, {
        ...
        _g6: function() {
            ...
            for (var b = 0; b < a.numSlides; b++) b === a.numSlides - 1 && (style = ""),
            d = a.slides[b],
            c += '<div class="rsNavItem rsTab">' + d.thumbnail + "</div>";
            c = e(c + "</div>");
            a._k5 = c;
...
(function(f) {
    f.extend(f.rsProto, {
        ...
        updateThumbsSize: function() {
            ...
            if (a._w3 < a._x3) a.st.thumbs.autoCenter && a._o3((a._x3 - a._w3) / 2),
...
(function(d) {
    d.rsProto._e7 = function() {
        ...
        a._f7, a.st.visibleNearby), a.ev.one("rsAfterPropsSetup",
        function() {
