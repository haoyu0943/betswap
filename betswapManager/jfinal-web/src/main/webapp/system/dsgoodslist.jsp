    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
                <div id="tabsF" class="ejdhBox">
                    <ul class="ejcdUl">
                        <li><a href="<%=ctxPath%>/system/dsgoodslist" class="active-li"><lan set-lan="html:dsgoodslist.pending.goods">待审商品</lan></a></li>
                        <li><a href="<%=ctxPath%>/system/goodslist" ><lan set-lan="html:dsgoodslist.approved.goods">已审商品</lan></a></li>
                        <div class="clear"></div>
                    </ul>
                </div>
            <div class="page-inner">
                    ...
                    <button type="button" class="btn btn-sm btn-success" onclick="qryPageDsGoods()"><lan set-lan="html:movielist.query">查询</lan></button>
        ...
        function qryPageDsGoods(){
            ...
            var columns =[
                {data: "rownum",render: function(data, type, row, meta) {
                    ...
                    showstr+="</td>";
                    showstr+="<td class=\"td-pass\" width='120px'>"+
            ...
            getTableDataServer("infoTable",ctxPath+"/system/qryPageDsGoods",columns,data,false);
        }

        function examine(recordid){
            var url="<%=ctxPath%>/system/goodsDetail?checkflg=1&recordid="+recordid;
