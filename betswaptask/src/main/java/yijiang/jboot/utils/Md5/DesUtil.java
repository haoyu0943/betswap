package yijiang.jboot.utils.Md5;
...
//        System.out.println(">>>>>>>>>>默认秘钥加密后："+decrypt(encrypt(data)));
        System.out.println(">>>>>>>>>>默认秘钥加密后："+encrypt("root"));
        System.out.println(">>>>>>>>>>默认秘钥加密后："+encrypt("Yijiang@2021"));
